...
#ifndef sector_MAIN_H
#define sector_MAIN_H
...
static const int COINBASE_MATURITY_PPC = 80;
...
static const int STAKE_MIN_AGE = 60 * 60 * 8;
...
public:
    ...
    {
        // Sector: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of sectors spent by this transaction.
    ...
    /** Amount of sectors coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // Sector: get transaction coin age
...
public:
    ...
    // Sector: block signature - signed by coin base txout[0]'s owner
    ...
    // Sector: two types of block: proof-of-work or proof-of-stake
    ...
    // Sector: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // Sector: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // Sector: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // Sector: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // Sector: block index flags
    enum  
    {
    ...
    /**
     * Duplicate from sectorrpc that originaly define this method.
