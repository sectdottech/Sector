...
// unsigned char pchMessageStartTestsector[4] = { 0xfa, 0xbf, 0xb5, 0xda };
...
// Sector message start (switch from sector's in v0.2)
static unsigned char pchMessageStartsector[4] = { 0x2b, 0x3b, 0x4c, 0x2d };
static unsigned char pchMessageStartSector[4] = { 0x3a, 0x2b, 0x4c, 0x3d };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartSector : pchMessageStartsector, sizeof(pchMessageStartSector));
}
