...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(sectorUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = sectorUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance)
{
    ...
    ui->labelStake->setText(sectorUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(sectorUnits::formatWithUnit(unit, unconfirmedBalance));
}
