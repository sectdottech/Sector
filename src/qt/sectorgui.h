...
/**
  sector GUI main class. This class represents the main window of the sector UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class sectorGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit sectorGUI(QWidget *parent = 0);
    ~sectorGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a sector wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
