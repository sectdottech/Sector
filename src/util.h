...
#ifndef sector_UTIL_H
#define sector_UTIL_H
...
#ifdef WIN32
typedef HANDLE sector_pthread_t;

inline sector_pthread_t CreateThread(void(*pfn)(void*), void* parg, bool fWantHandle=false)
{
    DWORD nUnused = 0;
    HANDLE hthread =
        CreateThread(
    ...
    if (hthread == NULL)
    {
        ...
        return (sector_pthread_t)0;
    }
    if (!fWantHandle)
    {
        CloseHandle(hthread);
        return (sector_pthread_t)-1;
    }
    return hthread;
}
