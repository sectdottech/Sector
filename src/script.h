...
#ifndef H_sector_SCRIPT
#define H_sector_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CsectorAddress
 */
...
public:
    ...
    // Pre-version-0.6, sector always counted CHECKMULTISIGs
