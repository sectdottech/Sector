...
contains(sector_NEED_QT_PLUGINS, 1) {
    DEFINES += sector_NEED_QT_PLUGINS
...
SOURCES += src/qt/sector.cpp src/qt/sectorgui.cpp \
...
contains(sector_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = sector-qt_test
DEFINES += sector_QT_TEST
}

CODECFORTR = UTF-8

# for lrelease/lupdate
# also add new translations to src/qt/sector.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/sector_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/sector-qt.rc
...
windows:RC_FILE = src/qt/res/sector-qt.rc
...
macx:ICON = src/qt/res/icons/Sector.icns
macx:TARGET = "Sector"
